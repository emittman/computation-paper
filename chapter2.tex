...
Time per MCMC iteration in seconds for each simulation. It appears that the time required grows sublinearly in $G$ and linearly in $K$. We should note that the sample size, $N$, itself has no impact, because the sufficient summary statistics do not scale with $N$.
